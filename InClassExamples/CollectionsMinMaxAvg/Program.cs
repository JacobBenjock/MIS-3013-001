...
namespace CollectionsMinMaxAvg
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double sum = 0; // this is often referred to as an accumulator
            ...
            Console.WriteLine($"Your maximum score is {maximum.ToString("N3")}.");
            Console.WriteLine($"Your minimum score is {minimum.ToString("N3")}.");
